...
// $freq = 'sqjgcnbudvwzemkxyaltfioprh';
// $freq = 'sqjnubdgcwzvmtexyklaiforhp';
// $freq =  'scqjubgndzvwytmxlkaefoihrp';

$guess = 'etaonisrhdulcmfywgpbvkxqjz';
// $guess = 'etaoinsrhdlucmfywgpbvkxqjz';
...
//  var_dump(str_replace(' ', '', $plainmaybe));
